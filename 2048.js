...
var client = Netcat.client(2048, '41.231.53.40');
 
var my2048;
var my2048arr = new Array (4)
var my2048_lines = new Array (4)
...
client.on('data', function (data) {
  ...
  for (i=0; i<4; i++) {
   for (j=0; j<4; j++) {
     ...
     tile.y = j;
     if (my2048arr [i][j] > 0) {
     // tile.value = my2048arr [i][j];
        //console.log(tile);
    this.grid.insertTile(tile);}
   }
  }
  //this.ai.grid.cells = my2048arr;
  this.ai = new AI(this.grid);
//console.log(this.ai.grid.cells);
// this.ai.getBest().move
 
  console.log(my2048.toString('ascii'));
  //console.log(my2048arr);
...
/*
, , , , , ['l', 'd', 'u', 'r'], ['r', 'l', 'u', 'd'], ['r', 'l', 'd', 'u'], ['r', 'u', 'l', 'd'], ['r', 'u', 'd', 'l'], ['r', 'd', 'l', 'u'], , ['u', 'l', 'r', 'd'], ['u', 'l', 'd', 'r'], ['u', 'r', 'l', 'd'], ['u', 'r', 'd', 'l'], ['u', 'd', 'l', 'r'], ['u', 'd', 'r', 'l'], ['d', 'l', 'r', 'u'], ['d', 'l', 'u', 'r'], ['d', 'r', 'l', 'u'], ['d', 'r', 'u', 'l'], ['d', 'u', 'l', 'r'], ['d', 'u', 'r', 'l']
*/
/*
['l', 'r', 'u', 'd'], ['l', 'r', 'd', 'u'], ['l', 'u', 'r', 'd'], ['l', 'u', 'd', 'r'], ['l', 'd', 'r', 'u'], ['l', 'd', 'u', 'r'], ['r', 'l', 'u', 'd'], ['r', 'l', 'd', 'u'], ['r', 'u', 'l', 'd'], ['r', 'u', 'd', 'l'], ['r', 'd', 'l', 'u'], ['r', 'd', 'u', 'l'], ['u', 'l', 'r', 'd'], ['u', 'l', 'd', 'r'], ['u', 'r', 'l', 'd'], ['u', 'r', 'd', 'l'], ['u', 'd', 'l', 'r'], ['u', 'd', 'r', 'l'], ['d', 'l', 'r', 'u'], ['d', 'l', 'u', 'r'], ['d', 'r', 'l', 'u'], ['d', 'r', 'u', 'l'], ['d', 'u', 'l', 'r'], ['d', 'u', 'r', 'l']
*/
...
console.log(("i move" + myMove[nowMove]));
});
